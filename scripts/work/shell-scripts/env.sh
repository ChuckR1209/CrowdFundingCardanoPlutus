...
export BASE=/home/chakravarti/emurgocdp2/emurgoCardano
...
# Loading keys
export FOR_PLUTUS_VKEY=$BASE/.priv/wallets/forPlutus/forPlutus.vkey
export FOR_PLUTUS_SKEY=$BASE/.priv/wallets/forPlutus/forPlutus.skey
# export PAYMENT_ADDR=
